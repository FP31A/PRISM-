...
#PBS -o logs/step9/step9v2.out
#PBS -e logs/step9/step9v2.err
#PBS -j oe
...
echo "=========================================================="
echo "PRISM Step 9v2 — Model Training, Ablation, Screening, LC"
echo "=========================================================="
echo "Start:     $(date)"
echo "Node:      $(hostname)"
echo "CPUs:      $(nproc)"
...
# ── Run ──
python -u src/models/train.py 2>&1 | tee logs/step9/step9v2_full.log
